...
ActiveRecord::Schema.define(version: 2020_05_16_143433) do
  ...
  create_table "invesments", force: :cascade do |t|
    t.bigint "user_id"
    t.bigint "client_id"
    t.string "ein"
    ...
    t.index ["client_id"], name: "index_invesments_on_client_id"
  ...
  add_foreign_key "invesments", "clients"
